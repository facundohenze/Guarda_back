...
- Incoherencia entre título y descripción: verificá si la descripción tiene alguna relación con el incidente mencionado en el título. No importa si la descripción es breve o poco detallada — alcanza con que hable del mismo problema o de su contexto (ej: título "bache en la vereda" y descripción "hay un pozo bastante grande" es válido aunque sea escueto). Marcá como inválido si la descripción claramente no tiene ningún punto de contacto con el incidente del título. En "razon" explicá amablemente que el título y la descripción no parecen referirse al mismo problema, y pedile que los revise.
